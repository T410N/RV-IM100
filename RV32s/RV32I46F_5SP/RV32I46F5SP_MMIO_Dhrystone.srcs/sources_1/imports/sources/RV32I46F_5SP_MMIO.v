...
module RV32I46F5SP_CORE #(parameter XLEN = 32)(
    input clk,
    input clk_enable,
    input reset,
    ...
    input [XLEN-1:0] data_memory_read_data,
    output [XLEN-1:0] data_memory_address,      // = MEM_alu_result
    output [XLEN-1:0] data_memory_write_data,
    output data_memory_write_enable,
    output [3:0] write_mask,
    output data_memory_read,         // ByteEnable에 필요

    // Debug / retire
    output [31:0] retire_instruction
);
    
    assign data_memory_write_enable = MEM_memory_write;
    assign data_memory_address = MEM_alu_result;
    assign data_memory_read = MEM_memory_read;
