...
#
# Script generated by Vivado on Wed Mar 04 14:10:58 KST 2026
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khwl/Desktop/RV-IM100/RV64s/SoCs/RV64IM_6SP/RV64IM72F_6SP.cache/compile_simlib/modelsim"
  fi
