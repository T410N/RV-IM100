...
#
# Script generated by Vivado on Thu Mar 05 23:47:10 KST 2026
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khwl/Desktop/RV-IM100/RV32s/SoCs/RV32IM_6SP/RV64IM72F_6SP.cache/compile_simlib/modelsim"
  fi
