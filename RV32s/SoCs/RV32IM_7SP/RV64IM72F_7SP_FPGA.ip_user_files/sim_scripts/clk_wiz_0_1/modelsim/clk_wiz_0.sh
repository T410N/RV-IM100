...
#
# Script generated by Vivado on Mon Mar 09 19:24:48 KST 2026
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khwl/Desktop/RV-IM100/RV32s/SoCs/RV32IM_7SP/RV64IM72F_7SP_FPGA.cache/compile_simlib/modelsim"
  fi
