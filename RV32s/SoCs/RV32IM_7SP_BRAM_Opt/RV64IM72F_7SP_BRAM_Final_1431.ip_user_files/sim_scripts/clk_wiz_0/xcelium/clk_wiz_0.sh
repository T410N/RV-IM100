...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../RV64IM72F_7SP_BRAM_Final_1431.gen/sources_1/ip/clk_wiz_0" \
  "/tools/Xilinx/2025.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \
  2>&1 | tee compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../RV64IM72F_7SP_BRAM_Final_1431.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khwl/Desktop/KHWL_2026/RV-IM100/RV32s/SoCs/RV64IM72F_7SP_BRAM_Final_1431/RV64IM72F_7SP_BRAM_Final_1431.cache/compile_simlib/xcelium"
  fi
