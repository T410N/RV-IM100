...
#
# Script generated by Vivado on Thu Mar 12 16:13:57 KST 2026
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khwl/Desktop/RV-IM100/RV32s/SoCs/RV32IM_8SP/RV64IM72F_8SP_100MHz.cache/compile_simlib/xcelium"
  fi
