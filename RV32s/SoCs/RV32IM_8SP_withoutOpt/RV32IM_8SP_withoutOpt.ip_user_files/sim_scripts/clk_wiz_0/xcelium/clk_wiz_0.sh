...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../RV32IM_8SP_withoutOpt.gen/sources_1/ip/clk_wiz_0" \
  "/tools/Xilinx/2025.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \
  2>&1 | tee compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../RV32IM_8SP_withoutOpt.gen/sources_1/ip/clk_wiz_0" \
