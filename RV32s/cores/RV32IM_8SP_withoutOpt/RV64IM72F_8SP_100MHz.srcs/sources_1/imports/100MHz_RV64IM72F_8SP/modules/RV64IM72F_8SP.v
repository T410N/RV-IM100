...
module RV32IM72F8SP_CORE #(
    ...
    ALU alu (
        ...
        .reset(reset),
        .src_A(EX_src_A),               // registered operand from the EXR_EX register
        .src_B(EX_src_B),               // registered operand from the EXR_EX register
        .alu_op(alu_op),
        .div_start(div_start),
        .div_busy(div_busy),
        .mul_start(mul_start),
    ...
    BranchLogic branch_logic (
        ...
        // ALU results from EX2 stage (with forwarding already applied in EXR stage)
    ...
    ForwardUnit forward_unit (
        ...
        .csr_hazard_ex2(csr_hazard_ex2),
        .csr_hazard_mem(csr_hazard_mem),
        .csr_hazard_wb(csr_hazard_wb),
        .EX2_csr_write_data(EX2_alu_result),
    ...
    HazardUnit hazard_unit (
        ...
        .EX2_rd(EX2_rd),
        .EX2_opcode(EX2_opcode),
        .EX2_csr_write_address(EX2_raw_imm[11:0]),
    ...
    TrapController #(.XLEN(XLEN))trap_controller (
        ...
        .trap_status(trap_status),
        .ID_pc(ID_pc),
        .EX_pc(EXR_pc),                 // EXR is the stage right after ID (was EX)
        .EX2_pc(EX2_pc),
        .MEM_pc(MEM_pc),
        .WB_pc(WB_pc),
        .csr_read_data(csr_read_out),
    ...
    // EX - EX2/BR pipeline register (inputs now from the EXR_EX register outputs)
    EX_EX2_Register #(.XLEN(XLEN)) ex_ex2_register (
        ...
        .EX_read_data1({XLEN{1'b0}}),   // read_data1 is consumed by the EXR source mux
    ...
    // (Moved out of the old EX stage - this is the critical path split)
    // =========================================================================
    always @(*) begin
        ...
        // ALU source A forwarding: 3'b001=EX, 3'b010=EX2, 3'b011=MEM, 3'b100=WB, 3'b101=Retire
