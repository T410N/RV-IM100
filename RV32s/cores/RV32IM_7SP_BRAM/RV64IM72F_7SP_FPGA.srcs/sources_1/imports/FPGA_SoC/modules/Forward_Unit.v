...
module ForwardUnit #(
    ...
    // 3'b000: no forwarding, 3'b001: EX2, 3'b010: MEM, 3'b011: WB, 3'b100: Retire
    assign alu_forward_source_select_a = 
            hazard_ex2[0] ? 3'b001 :
            hazard_mem[0] ? 3'b010 : 
            hazard_wb[0] ? 3'b011 : 
            hazard_retire[0] ? 3'b100 : 3'b000;

    assign alu_forward_source_select_b = 
            hazard_ex2[1] ? 3'b001 :
            hazard_mem[1] ? 3'b010 :
            hazard_wb[1] ? 3'b011 : 
            hazard_retire[1] ? 3'b100 : 3'b000;
    ...
    assign store_forward_enable = store_hazard_ex2 || store_hazard_mem || store_hazard_wb || store_hazard_retire;
    assign store_forward_data = store_hazard_ex2 ? EX2_forward_data_value : 
