...
module InstructionDecoder (
	...
	output [6:0] funct7,
	output [4:0] rs1,
	output [4:0] rs2,			// RV32I 5-bit shamt == rs2 field
	output [4:0] rd,
	...
	// RV32I: shamt occupies exactly the rs2 field, so no i_shift mux is needed.
    ...
    always @(*) begin
        case (opcode)
			...
			`OPCODE_RTYPE, `OPCODE_ATOMIC: begin // R type
				raw_imm = 20'b0;
			end
