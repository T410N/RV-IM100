...
module CSRFile #(
    ...
    wire [XLEN-1:0] mvendorid = 32'h52_4B_43_21;    // RISC-KC!
    wire [XLEN-1:0] marchid   = 32'h33_32_49_4D;    // RV32IM
    wire [XLEN-1:0] mhartid   = 32'h4E_41_4E_41;    // NANA
    wire [XLEN-1:0] mstatus   = 32'h00001800;       // MPP[12:11] = 11
    wire [XLEN-1:0] misa      = 32'h40001100;       // MXL = 1; XLEN = 32; misa[31:30] = 01. "I" misa[8], "M" misa[12].
    reg [XLEN-1:0] mtvec;
    reg [XLEN-1:0] mepc;
    reg [XLEN-1:0] mcause;

    // RV32 keeps the architectural 64-bit counters and exposes the upper
    // halves through mcycleh / minstreth.
    reg [63:0] mcycle;
    reg [63:0] minstret;
    ...
    always @(*) begin
        case (csr_read_address)
            ...
            12'hB80: csr_read_data = mcycle[63:32];      // mcycleh
            12'hB82: csr_read_data = minstret[63:32];    // minstreth
