...
synth_design -top RV64I59F5SP -part xc7a200tsbg484-1 -directive PerformanceOptimized -fsm_extraction one_hot -keep_equivalent_registers -resource_sharing off -no_lc -shreg_min_size 5 -mode out_of_context
...
write_checkpoint -force -noxdef RV64I59F5SP.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file RV64I59F5SP_utilization_synth.rpt -pb RV64I59F5SP_utilization_synth.pb"  } 
