...
#
# Script generated by Vivado on Thu Feb 26 16:03:49 KST 2026
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/khwl/Desktop/RV-IM100/RV64s/SoCs/RV64IM_7SP_BRAM/RV64IM72F_7SP_FPGA.cache/compile_simlib/xcelium"
  fi
