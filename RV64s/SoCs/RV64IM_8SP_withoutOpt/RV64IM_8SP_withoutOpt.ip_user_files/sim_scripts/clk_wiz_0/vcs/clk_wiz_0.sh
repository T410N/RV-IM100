...
#
# Script generated by Vivado on Fri Aug 21 16:55:15 KST 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../RV64IM_8SP_withoutOpt.gen/sources_1/ip/clk_wiz_0" \
  "/tools/Xilinx/2025.2/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \
  2>&1 | tee compile.log; cat .tmp_log > vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../RV64IM_8SP_withoutOpt.gen/sources_1/ip/clk_wiz_0" \
