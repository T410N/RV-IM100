...
module ExceptionDetector (
    ...
    always @(*) begin
        ...
        else if (EX_trapped && !branch_prediction_miss) begin
            trapped_combinatorial = 1'b1;
            trap_status_combinatorial = EX_trap_status;
        end
        else if (EXR_trapped && !branch_prediction_miss && !EX_jump) begin
            trapped_combinatorial = 1'b1;
            trap_status_combinatorial = EXR_trap_status;
        end
        else if (ID_trapped && !branch_prediction_miss && !EX_jump) begin
            trapped_combinatorial = 1'b1;
