...
module ForwardUnit #(
    ...
    output wire [2:0] store_forward_select,
    ...
    assign store_forward_select = 
        store_hazard_ex2    ? 3'b001 :
        store_hazard_mem    ? 3'b010 :
        store_hazard_wb     ? 3'b011 :
        store_hazard_retire ? 3'b100 : 3'b000;
    ...
    assign store_forward_enable = store_hazard_ex2 || store_hazard_mem ||
