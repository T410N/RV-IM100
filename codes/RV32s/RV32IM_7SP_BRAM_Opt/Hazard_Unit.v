...
module HazardUnit (
    ...
    wire retire_hazard_rs1 = EX_uses_rs1 && retire_register_write_enable && (retire_rd != 5'd0) && (retire_rd == EX_rs1);
    wire retire_hazard_rs2 = EX_uses_rs2 && retire_register_write_enable && (retire_rd != 5'd0) && (retire_rd == EX_rs2);
    ...
    wire store_retire_hazard_rs2 = EX_is_store && retire_register_write_enable && (retire_rd != 5'd0) && (retire_rd == EX_rs2);
    ...
    assign store_hazard_retire = store_retire_hazard_rs2 && !store_hazard_wb &&
                                 !store_hazard_mem && !store_hazard_ex2;
    ...
    always @(*) begin
        ...
        // Retire forwarding: enabled only when no newer producer is selected.
        hazard_retire[0] = retire_hazard_rs1 && !hazard_wb[0] && !hazard_mem[0] && !hazard_ex2[0];
        hazard_retire[1] = EX_is_store ? 1'b0 :
                           (retire_hazard_rs2 && !hazard_wb[1] && !hazard_mem[1] && !hazard_ex2[1]);
